...
#define FW_UPDATE_REQ_INTERVAL (5000)
	...
	enum
	{
		FW_CURRENT_APP_FW_INFO_REQ = AK_USER_DEFINE_SIG,
		FW_CURRENT_BOOT_FW_INFO_REQ,
		FW_UPDATE_REQ,
		FW_UPDATE_SM_OK,
		FW_TRANSFER_REQ,
...
#define AC_DISPLAY_SHOW_IDLE_BALL_MOVING_UPDATE_INTERVAL (150)
#define AC_DISPLAY_SHOW_MERRY_CHRISTMAS_SNOW_MOVING_UPDATE_INTERVAL (150)
...
#define EM_GAME_TIME_TICK_INTERVAL (20)
	...
	enum
	{
		...
		EM_GAME_DISPLAY_UPDATE_MATCH,
		EM_GAME_DISPLAY_UPDATE_SHOOTER,
		EM_GAME_DISPLAY_UPDATE_KEEPER,
		EM_GAME_DISPLAY_UPDATE_BALL,
		EM_GAME_TIME_TICK
	};
...
#define EM_GAME_MATCH_RIP_DURATION (2000)
	...
	enum
	{
		EM_GAME_MATCH_INIT = EM_GAME_DEFINE_SIG,
		EM_GAME_MATCH_SETUP,
		EM_GAME_MATCH_START,
...
#define EM_GAME_SHOOTER_ANIM_TICK_INTERVAL (80)
	...
	enum
	{
		...
		EM_GAME_SHOOTER_REQUEST_KICK_LEFT,
		EM_GAME_SHOOTER_REQUEST_KICK_CENTER,
		EM_GAME_SHOOTER_REQUEST_KICK_RIGHT,
		EM_GAME_SHOOTER_UPDATE,
...
#define EM_GAME_KEEPER_ANIM_TICK_INTERVAL (80)
	...
	enum
	{
		...
		EM_GAME_KEEPER_SET_DIFFICULTY,
		EM_GAME_KEEPER_REACT,
		EM_GAME_KEEPER_UPDATE,
...
#define EM_GAME_BALL_ANIM_TICK_INTERVAL (50)
	...
	enum
	{
		...
		EM_GAME_GOAL_BALL_ARRIVED,
		EM_GAME_GOAL_KEEPER_READY,
		EM_GAME_GOAL_RESET
	};
