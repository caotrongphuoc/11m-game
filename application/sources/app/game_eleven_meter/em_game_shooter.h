...
#define EM_GAME_SHOOTER_TARGET_LEFT_X (52)
#define EM_GAME_SHOOTER_TARGET_CENTER_X (56)
#define EM_GAME_SHOOTER_TARGET_RIGHT_X (60)
#define EM_GAME_SHOOTER_TARGET_Y (61)
