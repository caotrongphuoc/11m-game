...
extern void em_game_scoreboard_record_result(em_game_scoreboard_t* sb, em_game_result_t result);
...
extern em_game_winner_t em_game_scoreboard_evaluate_winner(em_game_scoreboard_t* sb);
