...
#define SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_WIDTH (30)
#define SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_HEIGHT (30)
#define SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_BOTTOM_PADDING (4)
#define SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_WIDTH (15)
#define SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_HEIGHT (20)
...
#define SCR_GAME_PENALTY_BOX_BOTTOM_LEFT_AXIS_X (28)
#define SCR_GAME_PENALTY_BOX_BOTTOM_RIGHT_AXIS_X (99)
...
void view_scr_game_penalty()
{
	...
	if ((view->flags & EM_GAME_VIEW_FLAG_SHOOTER_VISIBLE) != 0)
	{
		...
		{
			view_render.drawBitmap(
				view->shooter_x - (SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_WIDTH / 2),
				view->shooter_y - SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_HEIGHT + SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_BOTTOM_PADDING,
				bitmap_penalty_shooter_prepare,
				SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_WIDTH,
				SCR_GAME_PENALTY_SHOOTER_PREPARE_BITMAP_HEIGHT,
				WHITE);
		}
		else
		{
			view_render.drawBitmap(
				view->shooter_x - (SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_WIDTH / 2),
				view->shooter_y - SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_HEIGHT,
				scr_game_penalty_get_shooter_bitmap(),
				SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_WIDTH,
				SCR_GAME_PENALTY_SHOOTER_ACTION_BITMAP_HEIGHT,
				WHITE);
		}
	}
